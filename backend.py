...
def clean_price(price_str):
    try:
        # Fiyatı sayıya çevir: '4.199,00 TL' -> 4199.0
...
def compare():
    ...
    try:
        ...
        final_results = []
        forbidden = ["yedek", "parça", "filtre", "deterjan", "şampuan", "hortum", "aparat", "başlık", "aksesuar"]

        for item in shopping_results[:20]:
            # ÖNEMLİ: n11 hatasını çözmek için doğrudan linki alıyoruz
